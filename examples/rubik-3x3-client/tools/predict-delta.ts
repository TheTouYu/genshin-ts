...
// 用法：npx tsx examples/rubik-3x3-client/tools/predict-delta.ts <baseline.gil> <new.gil> <baselineActual>
...
if (!baseGil || !newGil || !baseActualStr) {
  console.error('用法: npx tsx examples/rubik-3x3-client/tools/predict-delta.ts <baseline.gil> <new.gil> <baselineActual>')
  process.exit(1)
}
