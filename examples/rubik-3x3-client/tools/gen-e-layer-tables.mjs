...
//
// 输出：examples/rubik-3x3-client/src/eLayerTables.ts（求解器图 import）
//        examples/rubik-3x3-client/tools/e-layer-policy.json（宏/策略留档）
...
const parts = []
parts.push('// 自动生成：node examples/rubik-3x3-client/tools/gen-e-layer-tables.mjs —— 勿手改')
