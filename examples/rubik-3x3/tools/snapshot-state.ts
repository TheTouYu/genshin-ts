...
// 用法：npx tsx examples/rubik-3x3/tools/snapshot-state.ts <label> [actualCount]
...
if (!label) {
  console.error('用法: npx tsx examples/rubik-3x3/tools/snapshot-state.ts <label> [actualCount]')
  process.exit(1)
}
