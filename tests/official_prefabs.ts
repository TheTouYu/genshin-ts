...
assert.equal(isOfficialResourceId(1000014), true)
assert.equal(isOfficialResourceId(2_000_002), true)
assert.equal(isOfficialResourceId(2_000_003), false)
assert.equal(isOfficialResourceId(999_999), false)
