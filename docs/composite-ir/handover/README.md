...
| layout-next | [layout-handover-next-iteration.md](layout-handover-next-iteration.md)                             | 下一轮小步游戏内验证流程         | 当前推荐交接入口；下一轮从 long-input 两层数据链开始，每步导出独立 GIA、等待游戏内反馈、通过后提交                                                            |
