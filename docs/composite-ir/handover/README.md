...
| layout-r14  | [layout-handover-round-14.md](layout-handover-round-14.md)                                         | 数据链局部压缩 + 控制流 yfix 回归 | 数据链 compact 已完成并归档；yfix3 缓解 R6-C root 分支掉到底部且无回归，但 R6-D 复合 impl 仍有局部控制流线/数据节点贴近问题，下一轮继续。 |
| layout-next | [layout-handover-next-iteration.md](layout-handover-next-iteration.md)                             | 下一轮小步游戏内验证流程         | 早期下一轮入口，已被 layout-r11/r12/r13/r14 继续推进；后续优先读最新 layout-r14，再按小步导出/游戏内反馈/通过后提交流程继续                                           |
