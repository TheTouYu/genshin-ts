...
| layout-r14  | [layout-handover-round-14.md](layout-handover-round-14.md)                                         | 数据链局部压缩                   | 当前下一轮入口：从主图同构 `step4-compact-chain` 开始，再回归复合 impl `step6-compact-chain`；保持 Round 13 防倒退和参数栈约束。                 |
