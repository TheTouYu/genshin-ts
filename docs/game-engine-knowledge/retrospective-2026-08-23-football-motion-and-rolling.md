...
> 范围：examples/football 从“加力后球躺原地微旋”到“高吊可弹跳、横传可滚、旋转正确、飞行速度连续”的一波修复。
> 视角：运动器叠加语义 / 位置型与速度型运动器选择 / 状态机对弹跳-滚滑转换的建模 / 视觉目标与物理积分的一致性。
> 证据：提交 6fdcfa3、48b680d、e23b817；日志 2828、2829、2830；
>       真实地图 1073741908.gil 注入后回读（kick_launch 1610710015 / phys_fly_tick 1610710011 / phys_roll_integrate 1610710010 / motion_to_point 1610710000）。
> 状态：阶段 1/2 已由用户游戏核验（球能动、旋转方向正确、摩擦改善）；阶段 3 已注入待用户复测“虚拟天花板”是否消失。
