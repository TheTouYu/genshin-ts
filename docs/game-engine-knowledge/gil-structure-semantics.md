...
技能配置类型（2026-08-29 两张真实样本）：

```text
f2=36 普通/瞬发技能  → folder typeValue=7500（folderId=68），ID 段 0x49400001(1228931073)
f2=6  自定义技能     → folder typeValue=2800（folderId=12），ID 段 0x41800001(1098907649)
普通 vs 瞬发 = 4[1].30.1.1.4（有 4:2=普通/有延时，缺省=瞬发）
默认事件轨道差异：普通技能=1 条轨道（节点图事件轨道）；自定义技能=2 条轨道
（节点图事件轨道 f6=805306369 + 状态轨道 f6=805306376）。
```
