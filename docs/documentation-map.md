...
| 开发客户端节点支持 | [`architecture/client-node-support-plan.md`](architecture/client-node-support-plan.md) | WP0 已完成两个真实 6.7 client skill GIA 的语义与 wire 基线；生产实现尚未开始，后续 vendor/定义/运行时/Stage 3 工作包仍需逐包授权和验证。 |
