...
export type GstsStaticAssemblyComponent =
  ...
  | {
       ...
       * 区域几何与选项内部数值（f503/f504=13 等）固定为真实样本值，不公开为参数。
       *
       ...
       * Region geometry and internal option values (f503/f504=13 etc.) are fixed
       * to the observed real snapshot and not exposed as parameters.
       */
      type: 'tabBar'
