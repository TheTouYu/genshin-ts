...
// 静态元件 root8 实例（1077936140，resID 10009008 圆柱，用户“动态→静态”转换后真实记录）。
// 结构：f1=实例ID、f2={1:resID,2:1}、f5×10 能力槽、f6×15 节点树（槽1.f11=transform）、
// f8=resID；**无 f7 组件槽**（静态资源只支持基础变换，无组件/变量/高级功能）。
const STATIC_INSTANCE_SKELETON =
  ''
...
const SKELETON_STATIC_INSTANCE_ID = 1077936140
const SKELETON_STATIC_INSTANCE_RESOURCE_ID = 10009008
...
/**
 * 生成“静态元件”root8 实例记录（用户动态→静态转换后的真实结构）：
 * 与官方记录同构但**无 f7 组件槽**（静态资源只支持基础变换，无组件/变量/高级功能）。
 * 来源样本：after-convert-10009008-static.gil 实例 1077936140。
 */
export function buildStaticPrefabRecord(params: {
  id: number
  resourceId: number
  name: string
  transform: PrefabTransform
}): Uint8Array {
  let record: Uint8Array = Buffer.from(STATIC_INSTANCE_SKELETON, 'hex')
